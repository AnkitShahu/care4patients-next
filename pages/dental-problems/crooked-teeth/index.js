...
import crookedTeeth3 from "../../../public/dental-problems-img/crooked teeth/Crooked_Teeth_03.png"
                                ...
                                <List>
                                    <ListItem>
                                        <Grid container spacing={2}>
                                            ...
                                            <Grid item xs={12} md={2} className='d-flex justify-content-center'><Image src={crookedTeeth3} alt="Image" className='img-fluid' />
                                            </Grid>
                                        </Grid>
                                    </ListItem>
                                    <ListItem>
