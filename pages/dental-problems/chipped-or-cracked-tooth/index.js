...
import chippedTooth3 from "../../../public/dental-problems-img/chipped or cracked tooth/Chipped_or_Cracked_Tooth_03.png"
                                ...
                                <List>
                                    <ListItem>
                                        <Grid container spacing={2}>
                                            ...
                                            <Grid item xs={12} md={2} className='d-flex justify-content-center'><Image src={chippedTooth3} alt="Image" className='img-fluid' />
                                            </Grid>
                                        </Grid>
                                    </ListItem>
                                    <ListItem>
                                ...
                                <div className="accordion-item">
                                        ...
                                        <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div className="accordion-body">
                                                ...
                                                The sooner you seek dental care for a chipped or cracked tooth, the better. Early diagnosis and prompt treatment are critical to preventing infection, preserving the tooth structure and avoiding extensive repairs or extraction down the road.
</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="accordion-item">
                                        ...
                                        <div id="collapseFive" className="accordion-collapse collapse show" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                            <div className="accordion-body">
                                                ...
                                                Without intervention, a damaged tooth is prone to worsening as pieces continue to break off or cracks expand. Bacteria seep into fractures, allowing decay to spread inside the tooth. The inner pulp tissue can become irritated and inflamed, leading to recurrent pain and sensitivity.
</div>
                                            </div>
                                        </div>
                                    </div>
