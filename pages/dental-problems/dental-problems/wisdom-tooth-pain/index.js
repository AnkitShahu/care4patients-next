                                    ...
                                    <div className="accordion-item">
                                        ...
                                        <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div className="accordion-body">
                                                <div className='para'>Tooth loss can result from a variety of factors, including decay, gum disease, injury, or trauma.</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="accordion-item">
                                        ...
                                        <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                            <div className="accordion-body">
                                                <div className='para'>Yes! Missing teeth can impact your ability to eat and speak properly, which in turn affects your nutrition and confidence. It may also lead to bone loss in the jaw over time.</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="accordion-item">
                                        ...
                                        <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                            <div className="accordion-body">
                                                <div className='para'>The duration depends on the treatment plan selected by your dentist. In some cases, where there is enough healthy bone available at the site of the gap left behind by the missing tooth/teeth, an implant-supported crown can be completed relatively quickly - sometimes within one day!</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="accordion-item">
